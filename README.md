...
```text
okos-belepteto/
├── docs/         # Itt található a projekt dokumentáció és az ahhoz felhasznált screenshotok.
...
A projekt dokumentáció elérhető `.md`, `.docx` és `.pdf` formátumban is a `docs` mappában.